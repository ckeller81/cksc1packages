...
namespace CkSoftware.ImageWatermark
{
	...
	///     </remarks>
	/// Source: http://weblog.west-wind.com/posts/2009/Nov/13/Capturing-and-Transforming-ASPNET-Output-with-ResponseFilter
	/// </summary>
	public class ResponseFilterStream : Stream
	{
		...
		{
			if (IsCaptured && _cacheStream.Length > 0 && _cacheStream.Length == Convert.ToInt32(HttpContext.Current.Response.Headers["Content-Length"]))
			{
